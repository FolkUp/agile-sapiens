...
Современная индустрия гибких методологий перевернула логику: сначала сертификат, потом практика. Двухнедельный цикл разработки (спринт: sprint, рабочий период фиксированной длины). Почему именно двухнедельный? Потому что так написано в руководстве по скраму (Scrum Guide: официальный документ методологии Scrum). Диккенс публиковал ежемесячно — таков был цикл типографии; Верн публиковал раз в две недели — таков был цикл журнала. Их итерации были калиброваны под реальные ограничения, тогда как корпоративный цикл разработки калиброван под теоретическую норму.
...
Диккенс изобрёл цикл обратной связи задолго до того, как термин появился в теории управления. Каждый выпуск — гипотеза: «Этот поворот сюжета удержит аудиторию», и тираж следующего выпуска становился валидацией (validation: подтверждением гипотезы). Когда выпуск с Сэмом Уэллером поднял продажи, Диккенс немедленно увеличил его роль² — решение на основе данных, принятое за полтора века до A/B-тестирования (A/B testing: сравнение двух вариантов).
...
Когда в 1841 году Диккенс убил маленькую Нелл в «Лавке древностей», корабли из Америки встречали толпы на пристанях с криком: «Она умерла?» Первое в истории вовлечение сообщества (community engagement: взаимодействие с аудиторией) — и обратная связь, пересекающая океан.
...
Для каждого романа Верн собирал экспертизу: «Двадцать тысяч лье» требовали океанографов, инженеров и ботаников; «С Земли на Луну» (1865) — баллистиков и астрономов. Этцель выполнял роль владельца продукта (Product Owner: ответственный за видение продукта), определяя формат, сроки, аудиторию, тогда как Верн играл роль технического лидера (Technical Lead: руководитель разработки). Иллюстраторы становились дизайнерами, а подписчики, заинтересованные стороны (stakeholders: участники процесса), имели право голоса через единственную метрику — покупку или отказ.
...
Ракуго (японское искусство комического монолога) существует с XVII века. Мастер ракуго рассказывает одну историю сотни раз, внося микро-корректировки на основании реакции зала, — кайдзен (kaizen: непрерывное улучшение) в чистом виде. Каждое выступление становится спринтом (sprint: рабочий период): реакция аудитории — это демо (demo: демонстрация результата); корректировка — ретроспектива (retrospective: анализ прошедшего цикла).
...
Такеучи и Нонака опубликуют в 1986 году «The New New Product Development Game» — текст, ставший основой для Скрама (Scrum: методология итеративной разработки). Их «подход регби» — это формализация паттерна, который мастера ракуго практиковали столетиями. Такеучи и Нонака, возможно, впитали этот паттерн через культуру: оба выросли там, где ракуго был повседневным развлечением, а кайдзен — бытовым словом задолго до Тойоты (Toyota).
