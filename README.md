...
Last production deploy: PR #98 (AGIL-187 Batch A — accessibility remediation: site-wide landmark structure + reading-mode/cookie-banner contrast; earlier PR #96 repaired `/apparatus/`, PR #95 added the homepage download buttons), merged 2026-05-22; production verified via axe-core + headless browser (Playwright) on desktop + mobile, light + dark — all 6 landmark axe rules and both contrast failures cleared site-wide. The AGIL-187 audit's accessibility front (A1/A2/A4) is resolved; SEO (Batch B), EN-removal (Batch C) and the new cover (AGIL-185) remain.  
