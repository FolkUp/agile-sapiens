...
**Status:** AGIL-190 Theme Correction Phase 2 — Batches 1 + 2 + 3 + 4 SHIPPED (PR #107 Mina 2026-05-24 + PR #110 Jekyll corporate-dualism rewrite 2026-05-24 + PR #112 Don Quixote team-mythology rewrite 2026-05-25 + PR #114 Wells *Time Machine* labor-horizons rewrite 2026-05-25). Pre-publisher polish batch landed (PRs #81–#90). Post-batch: AGIL-186 homepage download buttons (PR #95); AGIL-187 full site audit (4 fronts) — Batch A accessibility (PR #98), Batch C EN-removal (PR #99), Batch B SEO meta/schema (PR #101); AGIL-185 new Victorian SVG/CSS cover (PR #103 + PR #104 hotfix).
...
No P0 blockers; AGIL-190 is the active P1 (multi-session campaign, 4 batches remaining: Ch.9 replace Vinge→Стругацкие, Ch.10 replace Gibson→Камю, afterword rewrite, final cross-refs sweep + mono% remeasure for Ch.6/p1+p2, Ch.7 и Ch.8).
...
| 8-time-machine | — | — pending remeasure after AGIL-190 Batch 4 rewrite | rewritten chapter |
...
**Last Updated:** 2026-05-25 (PR #114 — AGIL-190 Batch 4 Wells *Time Machine* rewritten around horizons of labor transformation — Wells-as-Fabian + Autor labor polarization + Acemoglu-Johnson institutional choice + Polanyi double-movement + Платонов «Котлован» Russian voice; 191 lines; 0 ИИ; 2 alphabetical fixes pre-merge: Платонов/Поланьи/поляризация П-section positions corrected, «Великая трансформация»/«Власть и прогресс» moved before «Вокруг света»)  
