...
> **AGIL-190 Theme Correction Phase 2 in progress (kickoff 2026-05-24):** the 2026-05-19 "Literary Theme Correction" (AGIL-170) cleaned the book frame (homepage, about, cover, EPUB/PDF templates) but the chapter bodies 6-10 + afterword retained the AI overlay (16-125 ИИ mentions per chapter; Ch.0-5 were always Agile-faithful). Multi-session campaign: Ch.6/p1 NEW chapter (Stoker / Мина Харкер / Crew of Light — Victorian distributed-knowledge-base team, Agile-frame), Ch.6/p2 cleanup (Stevenson Jekyll-Hyde — corporate dualism, drop "intelligence amplification" overlay), Ch.7 cleanup (Cervantes Don Quixote — team mythmaking, drop algorithm overlay), Ch.8 cleanup (Wells Time Machine — labor-transformation horizons, drop AI overlay), Ch.9 REPLACE author (Vinge → Стругацкие НИИЧАВО), Ch.10 REPLACE author (Gibson → Камю «Чума»), afterword REWRITE (synthesis + 11-archetype toolkit). Each chapter = separate session with hostile-review plan + result. Editorial estimate: ~45-60 hours over multiple sessions.
...
Last production deploy: PR #104 (AGIL-185 hotfix — sync regenerated EPUB/PDF from `formats/` to `static/downloads/`), merged 2026-05-24, prod-verified — downloads now serve the new cover (content-length 11295125 / 3878862). Earlier same day: PR #103 (AGIL-185 new Victorian SVG/CSS cover + S5 OG card; EPUB/PDF regenerated in `formats/`). Earlier 2026-05-22: PR #101 (AGIL-187 Batch B — SEO meta/schema, plus a pre-existing JSON-LD double-encoding bug fixed site-wide — 167/167 blocks parse valid), PR #98 (Batch A accessibility — landmarks + contrast), PR #99 (Batch C — EN-removal). AGIL-187 audit fronts done: accessibility (A), EN-removal (C), SEO (B), new cover + S5 OG (via AGIL-185); remaining: link-audit finish (in-page anchors).  
Quality gates: 5/5 passed per quality-gate-report.json.  
EPUB v1.0.7: 11.3 MB (cover + 16 plates + preface + 12 chapters + 3 intermezzi + afterword + 7 apparatus pages, 27 spine items) — regenerated 2026-05-24 with the new cover.  
PDF v1.0.7: 3.7 MB / 255 pages (cover first page + same content structure as EPUB minus chapter-body plates) — regenerated 2026-05-24 with the new cover.
