...
**Status:** AGIL-190 Theme Correction Phase 2 — Batches 1 + 2 SHIPPED 2026-05-24 (PR #107 Mina + PR #110 Jekyll corporate-dualism rewrite). Pre-publisher polish batch landed (PRs #81–#90). Post-batch: AGIL-186 homepage download buttons (PR #95); AGIL-187 full site audit (4 fronts) — Batch A accessibility (PR #98), Batch C EN-removal (PR #99), Batch B SEO meta/schema (PR #101); AGIL-185 new Victorian SVG/CSS cover (PR #103 + PR #104 hotfix).
...
No P0 blockers; AGIL-190 is the active P1 (multi-session campaign, 6 batches remaining: Ch.7 cleanup, Ch.8 cleanup, Ch.9 replace Vinge→Стругацкие, Ch.10 replace Gibson→Камю, afterword rewrite, final cross-refs sweep).
...
**Last Updated:** 2026-05-24 (post-PR-#110 — AGIL-190 Batch 2 Jekyll rewritten around corporate dualism, prod-verified via direct curl probe and hex-dump of 6а/6б mapping)  
