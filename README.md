...
> **Status:** 12/12 content units ≤25% mono per fresh measurement (2026-05-21T07:36 UTC); visual ecosystem 100%; multi-format pipeline (Web/EPUB/PDF) operational on production. AGIL-167 narrow-scope a11y closures deployed.
> **Latest 2026-05-21:** AGIL-167 narrow-scope WCAG gap closures — PR #78 (non-colour current-page indicator, WCAG 1.4.1) and PR #79 (distinct aria-label for primary `<nav>`, WCAG H97). Hostile review rejected 2 of 4 initially-flagged gaps as false positives (logo aria-label would violate WCAG 2.5.3; backToTop already has visible text). Broader items spun off: AGIL-172 URL portability for Cyrillic anchors (P3, not WCAG), AGIL-173 touch-target audit (P2). Earlier: PR #77 mono-table sync (Ch.6 part 1 = 6.6%, 5 chapters drifted vs 2026-05-15 report and synced).
