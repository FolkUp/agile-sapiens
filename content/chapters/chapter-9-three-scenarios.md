...
Сергей Петрович Белоусов, генеральный директор инвестиционного банка, смотрит на слайд с заголовком «AI Strategy Roadmap 2026-2031» и понимает: сегодняшнее решение определит, будет ли их банк существовать через пять лет.
...
**Предыстория:** Майкл Тибодо, глава алгоритмической торговли JPMorgan Chase, стоит перед выбором: полностью автоматизировать торговлю акциями или оставить человека в петле управления. Конкуренты уже перешли на 100% алгоритмическое исполнение. JPMorgan рискует отстать — или придумать третий путь.
...
Белоусов встает из-за стола. За окном светятся башни «Москва-Сити» — каждая компания в этих офисах сегодня принимает такие же решения. В каждой переговорной комнате кто-то держит четыре сценария Винджа и выбирает будущее своей компании.
