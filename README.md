...
> **Post-batch corrections:** PR #90 (README + PROJECT_CONTEXT docs sync) · PR #91 (hostile-audit YELLOW corrections — phantom-scrub of self-referential docs, EN `/about/` 404 fix, JSON-LD description). Production serves PR #91 content.
...
Last production content deploy: PR #91 (hostile-audit YELLOW corrections — phantom-scrub + EN /about/ fix + JSON-LD description), merged 2026-05-21 16:59 UTC.  
