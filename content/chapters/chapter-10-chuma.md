...
description: "Альбер Камю «Чума» 1947 — communauté доктора Рие, Тарру, Кастеля, Рамбера, Гран и Панлю: четыре закона длящейся работы под кризисом без горизонта победы — отказ как обязательство, общая порядочность вместо героизма, сходимость без иерархии, дисциплина продолжения."
date: 2026-05-25
...
og_description: "Камю «Чума» 1947: communauté Рие, Тарру, Кастеля, Рамбера, Гран и Панлю как операционная этика для команды без горизонта победы."
twitter_description: "Финал монографии: Камю показывает команду, которая держится на отказе уйти, а не на любви к ремеслу."
---
