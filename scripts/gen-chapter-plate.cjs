...
const PLATES = {
  ...
  ch9: {
    name: 'Plate 9 — Strugatsky NIICHAVO (Soviet research institute, self-organizing team)',
    aspect: '4:3',
    dimension: 'landscape',
    prompt: `${STYLE_PREFIX}. Interior of a Soviet 1960s scientific research institute, slightly fantastical. Multi-tiered open laboratory hall: ground floor with workbenches covered in books, instruments, scrolls, and a large mechanical-computation device (Aldan-3 era, brass dials and cathode-ray tubes); mezzanine level visible above with researchers at chalkboards covered in dense equations. Foreground left: a young researcher in shirt-sleeves at a desk, reading a folio; foreground right: an older bearded scholar (Хунта-archetype, severe figure, dark cloak) writing standing at a tall lectern; mid-ground center: two figures conversing over a shared instrument. Background: tall arched windows showing northern Soviet city silhouette at evening (no signage). Spectral chiaroscuro from oil lamps and the cathode tubes; mood is serious, intellectually charged, communal labor — anti-bureaucratic. Allegory of self-organizing R&D collective. Engraved plate aesthetic. Strugatsky brothers НИИЧАВО reference.`,
  },
  ch10: {
    name: 'Plate 10 — Camus La Peste (Oran under quarantine, sustained crisis ops)',
    aspect: '4:3',
    dimension: 'landscape',
    prompt: `${STYLE_PREFIX}. A Mediterranean coastal town under quarantine, mid-1940s. Empty narrow street descending toward a closed harbour visible in the distance, all shutters of the houses tightly drawn. Strong horizontal sunlight casts long sharp shadows; the light is harsh but the city is deserted — no figures in the street, no traffic, no markets. Foreground: the threshold of a modest medical station — open doorway in a stone wall, with a single doctor figure standing in the doorway with a black leather medical bag at his feet, wearing a long white coat and a cloth mask covering nose and mouth. Behind him, glimpsed through the open door, a corridor with a hand-cart and a stretcher. Mid-ground left: a poster pasted on a wall with the word PESTE / arrêté préfectoral visible. Mid-ground right: a single rat lying dead near a gutter. Architectural details: French colonial Algerian — whitewashed stucco walls, wrought-iron balconies, palm fronds in shadow. Atmosphere: claustrophobic, stifling, dust in the air, the heat palpable; no vacation-postcard prettiness — the town is sealed and exhausted. Mood: dignified endurance under impossibility, no heroism, no spectacle. Engraved plate aesthetic, monochrome sepia on ivory laid paper, dense crosshatching, spectral chiaroscuro. Allegory of communauté formation under sustained crisis. Camus La Peste 1947 reference.`,
  },
  int1: {
