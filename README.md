...
Last production content deploy: PR #93 (repaired broken `_default`/`apparatus` layout + stripped leaked internal meta-text from published content), merged 2026-05-22; production render verified via headless browser on desktop + mobile.  
