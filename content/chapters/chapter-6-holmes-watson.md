---
title: "Глава 6, часть 1: Холмс и Ватсон"
...
weight: 70
chapter: 6
plate_override: "agil-chapter-6-holmes-plate.webp"
act: "II: Archetypes"
category: "analysis"
status: "verified"
confidence: "high"
...
> **О чём эта глава.** Архетип человеко-машинного партнёрства. Как детективная методология Холмса и Ватсона за сто тридцать лет до появления первых ИИ-систем описывает принципы коллективного интеллекта: дополняющие роли, распределённая когниция, контроль качества через диалог. Шесть жемчужин Мэри Морстен, четыре стандартных вопроса Ватсона, и почему IBM Watson провалился ровно из-за того, что был назван Watson.
...
Они снимают квартиру. Они ещё не подозревают, что только что собрали первую в литературной истории команду из двух человек, которая будет работать почти полтора века спустя точно так же, как пары исследователей в современных лабораториях искусственного интеллекта: один генерирует гипотезы, другой проверяет их на конкретике, и оба знают — то, что получается вместе, ни один из них в одиночку не воспроизведёт.

¹ Doyle, Arthur Conan. *A Study in Scarlet* (1887). Ward, Lock & Co, London. Глава 1: «Mr. Sherlock Holmes» (перевод автора).

¹ᵃ Описание первой встречи воспроизводит детали из «Этюда в багровых тонах» с авторской интерпретацией метода дедукции.
